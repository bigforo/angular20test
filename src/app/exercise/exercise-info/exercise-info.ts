...
import { IonBackButton, IonButton, IonButtons, IonContent, IonFooter, IonHeader, IonIcon, IonItem, IonLabel, IonList, IonRouterLink, IonTitle, IonToolbar, NavController } from '@ionic/angular/standalone';
...
@Component({
  imports: [IonButtons, IonHeader, IonTitle, IonToolbar, IonFooter, IonButton, IonContent, IonLabel, NgStyle, IonIcon, IonList, IonItem, FormsModule, IonRouterLink, RouterLink, IonBackButton, ExHistory],
